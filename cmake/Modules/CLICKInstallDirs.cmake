...
if(CLICK_MODE)
    ...
    set(CMAKE_INSTALL_BINDIR "/lib/${BUILD_ARCH_TRIPLET}" CACHE PATH "user executables")
    ...
    set(CMAKE_INSTALL_DATAROOTDIR "/" CACHE PATH "read-only architecture-independent data root")
endif(CLICK_MODE)
